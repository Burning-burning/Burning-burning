...
3.4Availability
-----------------
3.1.4 Always consider the fault
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
|
3.1.5 Always consider how to expand
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
|
3.1.5 Respond to usability problems in a predictive and determined way.
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
